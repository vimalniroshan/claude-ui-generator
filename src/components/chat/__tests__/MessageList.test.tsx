...
test("MessageList renders tool-invocation parts with human-friendly labels", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList shows Working... for tool-invocation with no command args", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
...
test("MessageList renders file_manager rename with human-friendly label", () => {
  const messages: Message[] = [
    {
      id: "1",
      role: "assistant",
      ...
      parts: [
        {
          ...
          toolInvocation: {
            toolCallId: "call2",
            args: { command: "rename", path: "/Card.jsx", new_path: "/CardV2.jsx" },
  ...
  expect(screen.getByText("Renaming Card.jsx → CardV2.jsx")).toBeDefined();
});
